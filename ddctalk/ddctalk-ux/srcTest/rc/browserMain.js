...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/ddctalk': 'build/karma/src',
      'nmodule/ddctalkTest': 'build/karma/srcTest',
  ...
  define('nmodule/ddctalk/rc/ddctalk.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
    ...
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/ddctalkTest/rc/spec/allSpecs' ]
    }, function (err) {
